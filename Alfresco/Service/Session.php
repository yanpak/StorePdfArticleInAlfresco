...
class Session extends BaseObject {
	...
	/**
	 * Commits all unsaved changes to the repository (modified by Yan Pak)
	 *
	 * @param boolean $debug
	 * @return result of calling soap function or null if nothing happened or false if error was happened during this call
	 */
